...
REFERENCES Blocks(textbook_id, chapter_id, section_id, block_id),
FOREIGN KEY (textbook_id, chapter_id, section_id)
REFERENCES Sections(textbook_id, chapter_id, section_id),
FOREIGN KEY (textbook_id, chapter_id)
REFERENCES Chapters(textbook_id, chapter_id),
...
FOREIGN KEY (textbook_id, chapter_id) REFERENCES Chapters(textbook_id, chapter_id),
FOREIGN KEY (textbook_id, chapter_id, section_id) REFERENCES Sections(textbook_id, chapter_id, section_id),
FOREIGN KEY (textbook_id, chapter_id, section_id, block_id) REFERENCES Blocks(textbook_id, chapter_id, section_id, block_id),
FOREIGN KEY (textbook_id, chapter_id, section_id, block_id, activity_id)
REFERENCES Activities(textbook_id, chapter_id, section_id, block_id, activity_id)
);
...
REFERENCES Questions(textbook_id, chapter_id, section_id, block_id, activity_id, question_id)
);
